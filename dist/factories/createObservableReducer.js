...
exports.createObservableImmutableReducer = exports.createObservableReducer = void 0;
...
var createObservableImmutableReducer = function (store) {
    var createDispatch = store.createDispatch;
    var useObservableState = (0, createObservableState_1.createObservableImmutableState)(store);
    return function (key, reducer) {
        var reducerSingleton = (0, react_1.useRef)(reducer);
        reducerSingleton.current = reducer;
        var dispatch = (0, react_1.useMemo)(function () {
