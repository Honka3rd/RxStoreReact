...
declare const stateObserverManager: <S extends BS>(store: RxNStore<S> & Subscribable<S>) => {
    ...
    useObservableAsyncReducer: <K_3 extends keyof S, T_3 extends string>(key: K_3, reducer: import("rx-store-types").AsyncReducer<T_3, S, K_3>, fallback?: ReturnType<S[K_3]> | undefined) => readonly [import("./interfaces").AsyncMetaStates<ReturnType<S[K_3]>>, (action: import("rx-store-types").Action<ReturnType<S[K_3]>, T_3>) => void];
};
declare const immutableStateObserverManager: <S extends IBS>(store: RxImStore<S> & Subscribable<S>) => {
    ...
    useImmutableObservableAsyncReducer: <K_2 extends keyof S, T_3 extends string>(key: K_2, reducer: import("rx-store-types").AsyncReducer<T_3, S, K_2>, fallback?: ReturnType<S[K_2]> | undefined) => readonly [import("./interfaces").AsyncMetaStates<ReturnType<S[K_2]>>, (action: import("rx-store-types").Action<ReturnType<S[K_2]>, T_3>) => void];
};
