...
declare const stateObserverManager: <S extends BS>(store: RxNStoreImpl<S>) => {
    ...
    useObservableStates: <T_1 extends keyof S>(keys: import("rx-store-types").ConstraintKeys<T_1, T_1, T_1>) => { [k in T_1]: ReturnType<S[k]>; };
...
declare const immutableStateObserverManager: <S extends IBS>(store: RxImStoreImpl<S>) => {
    ...
    useImmutableObservableStates: <T_1 extends keyof S>(keys: import("rx-store-types").ConstraintKeys<T_1, T_1, T_1>) => import("immutable").Record<{ [K in T_1]: ReturnType<S[K]>; }> & Readonly<{ [K in T_1]: ReturnType<S[K]>; }>;
